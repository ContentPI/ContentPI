...
export const StyledHome = styled.div`
  .guide {
    ...
    .title {
      color: ${theme.colors.blue.zodiac};
      font-size: 15px;
      font-weight: 500;
      line-height: 20px;
      margin-bottom: 8px;
  ...
  .resources {
    ...
    .documentation {
      h3 {
        i {
          background: ${theme.colors.blue.onahau};
    ...
    .examples {
      h3 {
        i {
          background: ${theme.colors.yellow.buttermilk};
    ...
    .community {
      h3 {
        i {
          background: ${theme.colors.purple.blueChalk};
          color: ${theme.colors.purple.heliotrope};
        }
      }
    }
  }
